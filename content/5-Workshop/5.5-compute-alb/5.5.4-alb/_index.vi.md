...
Hiện tại ALB hoạt động với HTTP (cổng 80). Có thể bổ sung HTTPS với chứng chỉ ACM sau.

---

✅ **Tiếp theo:** [Monitoring](5.6-monitoring/) — CloudWatch alarms cho lỗi ALB, CPU RDS, và trạng thái ASG.
