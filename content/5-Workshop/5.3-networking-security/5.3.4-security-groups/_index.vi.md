...
Năm security group, mỗi nhóm một trách nhiệm:
...
Các luật egress cho S3 và DynamoDB (cổng 443 qua prefix lists) được thêm cùng các VPC Endpoints trong phần [Data Layer](5.4-data-layer/).
...
Không cần luật egress — RDS không bao giờ khởi tạo kết nối ra ngoài mà chúng ta cần kiểm soát.
...
| Hướng | Cổng (Port) | Nguồn | Mục đích |
|-----------|------|--------|--------|
| Ingress | 443 | VPC CIDR | Cho phép kết nối Session Manager từ mọi tài nguyên trong VPC |
