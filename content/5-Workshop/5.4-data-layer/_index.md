...
| **AWS Amplify** | Hosting & CDN | Host and serve the React/Vite static web app |
...
5. [AWS Amplify Hosting](5.4.5-amplify/) — React/Vite web app hosting with automatic SSL and global CDN
