...
Trong suốt 9 tuần thực tập tại **Amazon Web Services Viet Nam** (Chương trình First Cloud AI Journey), em đã thực hiện các nhiệm vụ từ việc tìm hiểu hạ tầng đám mây cơ bản, thiết kế kiến trúc Serverless, phát triển ứng dụng đến hoàn thiện báo cáo và chia sẻ kiến thức cho cộng đồng.

Dưới đây là bảng tổng hợp công việc chính theo từng tuần:

| Tuần | Khoảng thời gian | Công việc chính | Worklog |
| :---: | :---: | --- | :---: |
| **1** | 15/06 – 19/06/2026 | Tìm hiểu tổng quan về AWS, thiết lập tài khoản và các dịch vụ cơ bản (IAM, VPC, EC2) | [Xem](1.1-Week1/) |
